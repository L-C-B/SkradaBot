...
.setAuthor('Permission de bannir nécessaire ', 'https://cdn.discordapp.com/emojis/793046366254268427.png?v=1')
.setColor('#7bfbff')
...
const embed = new Discord.MessageEmbed()
.setAuthor(person.username + ' a été banni・' + reason, 'https://cdn.discordapp.com/emojis/793046366548918282.png?v=1')
.setColor('#7bfbff')
